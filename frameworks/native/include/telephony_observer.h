...
public:
    ...
    virtual void OnCellInfoUpdated(const std::vector<sptr<CellInformation>> &vec) override;
    virtual void OnSimStateUpdated(SimState state, LockReason reason) override;
