 ...
 */
#ifndef OHOS_STATE_REGISTRY_BRANCH_TEST_H
#define OHOS_STATE_REGISTRY_BRANCH_TEST_H
...
inline HapInfoParams testInfoParams = {
    .bundleName = "tel_state_registry_branch_test",
    .userID = 1,
    .instIndex = 0,
    .appIDDesc = "test",
    .isSystemApp = false,
...
inline HapPolicyParams testStateRegistryPolicyParams = {
...
SecurityToken::SecurityToken()
{
    ...
    AccessTokenIDEx tokenIdEx = AccessTokenKit::AllocHapToken(testInfoParams, testStateRegistryPolicyParams);
...
#endif // OHOS_STATE_REGISTRY_BRANCH_TEST_H